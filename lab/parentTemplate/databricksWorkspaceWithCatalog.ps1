...
New-AzResourceGroupDeployment -ResourceGroupName $rgName `
    -TemplateFile "databricksWithCatalogTemplate.json" `
    -Mode Complete `
    -location $Region `
...
$templatedeployment = Get-AzResourceGroupDeployment -Name "databricksWithCatalogTemplate" -ResourceGroupName $rgName
